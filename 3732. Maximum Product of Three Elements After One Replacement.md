...
<img width="1498" height="1189" alt="image" src="https://github.com/user-attachments/assets/d1f864aa-3f11-4057-a6ee-536bb5965146" />
...
class Solution {
    public long maxProduct(int[] nums) {
        ...
        for(int num : nums){
            ...
            if(abs > second){
                second = Math.min(abs,first);
                first = Math.max(abs,first);
            }
        }
        prod = prod * first * second * (long)Math.pow(10,5);
